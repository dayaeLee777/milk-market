  ...
  <div>
    ...
    >
      ...
      <div class="card-body row no-gutters align-items-center">
        ...
        <div class="col">
          <input class="form-control form-control-lg form-control-borderless" type="search" v-model="keyword" @keyup.enter="fnSearch" placeholder="Search topics or keywords">
        </div>
        <div class="col-auto">
        ...
        <tbody>
          <tr v-for="(content, idx) in contents" :key="idx">
            ...
            <td>
              ...
              <button @click="deleteCommunity(content.communityId)" type="button" class="btn-close" aria-label="Close"></button>
            </td>
          </tr>
    ...
    <div>
      <button type="button" class="btn btn-primary" @click ="communityWrite" style="float:right">
        글작성
      </button>
      
      <ul class="pagination" style="justify-content : center">
        <li class="page-item disabled"><a class="page-link" href="#">Previous</a></li>
        <li class="page-item active" ><a class="page-link" @click="fnGetPageList(1)" href="#" >1</a></li>
        <li class="page-item"><a class="page-link" @click="fnGetPageList(2)" href="#">2</a></li>
        <li class="page-item"><a class="page-link" @click="fnGetPageList(3)" href="#">3</a></li>
        <li class="page-item"><a class="page-link" @click="fnGetPageList(4)" href="#">4</a></li>
        <li class="page-item"><a class="page-link" @click="fnGetPageList(5)" href="#">5</a></li>
