...
|                       지갑 충전하기                       |
| :-------------------------------------------------------: |
| <img src="./readme_assets/지갑충전.gif" alt="지갑충전" /> |
...
|                       상품 구매하기                       |
| :-------------------------------------------------------: |
| <img src="./readme_assets/상품구매.gif" alt="상품구매" /> |
...
|                         상품검색                          |
| :-------------------------------------------------------: |
| <img src="./readme_assets/상품검색.gif" alt="상품검색" /> |
...
|                           상품 상세조회                            |
| :----------------------------------------------------------------: |
| <img src="./readme_assets/상품상세조회.gif" alt="상품 상세조회" /> |
...
|                          메인페이지                           |
| :-----------------------------------------------------------: |
| <img src="./readme_assets/메인페이지.gif" alt="메인페이지" /> |
...
|                         커뮤니티                          |
| :-------------------------------------------------------: |
| <img src="./readme_assets/커뮤니티.gif" alt="커뮤니티" /> |
